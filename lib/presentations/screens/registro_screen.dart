                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              validator: (value) {
                                ...
                                final regex =
                                    RegExp(r'^[a-zA-Z]{2}\d{5}@ues\.edu\.sv$');
                            ...
                            DropdownButtonFormField<Carreras>(
                                decoration: _buildInputDecoration(
                                    'Carrera', Icons.school_outlined),
                                items: listaCarreras
                                    .map<DropdownMenuItem<Carreras>>(
                                        (Carreras value) {
                                  return DropdownMenuItem<Carreras>(
                                      value: value,
                                      child: Text(value.nombre_carrera!));
                                }).toList(),
                                validator: (value) {
                                  if (value == null) {
                            ...
                            DropdownButtonFormField<String>(
                                ...
                                items: <String>[
                                  ...
                                  return DropdownMenuItem<String>(
                                      value: value, child: Text("$value° Año"));
                                }).toList(),
                                validator: (value) {
                                  if (value == null || value.isEmpty) {
                                    return "Por favor, selecciona una opcion";
                                    ...
                                    ? () {
                                        if (_formKey.currentState!.validate()) {
                                          ...
                                          User_register userRegister =
                                            ...
                                            carnet: _correoController!.text
                                                .substring(0, 7)
                                                .toUpperCase(),
                                            anioEstudio:
                                                int.parse(_anioCarrera!),
                                            direccion:
